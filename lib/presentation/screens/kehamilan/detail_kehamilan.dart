    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: kehamilan == null
              ? const Center(child: Text("Data kehamilan tidak tersedia"))
              : Column(
                  ...
                  children: [
                    ...
                    MenuButton(
                      ...
                      title: 'Persalinan',
                      enabled: kehamilan.persalinan?.isNotEmpty ?? false,
                      onTap: () {
                        final persalinans = kehamilan.persalinan;
                        if (persalinans == null || persalinans.isEmpty) return;

                        if (persalinans.length > 1) {
                          Navigator.pushNamed(
                            context,
                            AppRouter.listPersalinan,
                            arguments: {'persalinans': persalinans},
                          );
                        } else {
                          context
                              .read<SelectedPersalinanCubit>()
                              .selectPersalinan(persalinans.first);
                          Navigator.pushNamed(
                            context,
                    ...
                    Utils.generateRowLabelValue(
                      context,
                      label: "Hemoglobin",
                      value: kehamilan.hemoglobin?.toString(),
                      suffix: 'g/dL',
                    ),
                    Utils.generateRowLabelValue(
                      context,
                        ...
                        children: kehamilan.resti!
                            .map(
                              (r) => Container(
                                ...
                                color: context.themeColors.error.withOpacity(
                                  0.2,
                                ),
                                child: Text('- $r'),
                              ),
