...
class XAddPersalinanScreen extends StatefulWidget {
  final String kehamilanId;
  final String bumilId;

  const XAddPersalinanScreen({
    super.key,
  ...
  @override
  State<XAddPersalinanScreen> createState() => _PersalinanScreenState();
}

class _PersalinanScreenState extends State<XAddPersalinanScreen> {
