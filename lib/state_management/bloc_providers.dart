...
import 'package:ebidan/state_management/mode_bidan/kehamilan/cubit/get_kehamilan_cubit.dart';
import 'package:ebidan/state_management/mode_bidan/kehamilan/cubit/selected_kehamilan_cubit.dart';
import 'package:ebidan/state_management/mode_bidan/kunjungan/cubit/submit_kunjungan_cubit.dart';
...
import 'package:ebidan/state_management/mode_bidan/persalinan/cubit/submit_persalinan_cubit.dart';
...
class BlocProviders {
  List<BlocProvider> providers() {
    return [
      ...
      BlocProvider<CheckAccessCodeCubit>(
        create: (context) => CheckAccessCodeCubit(),
      ),
